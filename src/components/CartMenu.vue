    ...
    >
      ...
      <div id="bottom" class="flex flex-col h-full">
        ...
        >
          ...
          <button
            class="p-4 lg:p-2 2xl:p-2 bg-[#1d1d1d] rounded-full hover:opacity-90 font-inter border-y-4 border-[#00000000] disabled:opacity-20 disabled:hover:border-[#ff007a00] drop-shadow-[0_4.3px_1.4px_rgba(0,0,0,0.6)]"
          >
            <div id="button-contents" class="relative">
