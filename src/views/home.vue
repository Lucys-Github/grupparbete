...
<template>
  ...
  >
    ...
    >
      <div
        id="huge-neons"
        class="flex flex-col uppercase md:text-7xl xl:text-[12vh] font-extrabold drop-shadow-[0_4.3px_1.4px_rgba(0,0,0,0.9)] tracking-[-.3rem] font-inter"
      >
        <!-- don't know why the drop shadow isn't working |||| Working for me /emil -->
      ...
      <!-- huge neons -->
      <span
        class="md:text-3xl xl:text-[3.8vh] font-semibold uppercase font-antonio drop-shadow-[0_3.4px_1.4px_rgba(0,0,0,0.9)]"
